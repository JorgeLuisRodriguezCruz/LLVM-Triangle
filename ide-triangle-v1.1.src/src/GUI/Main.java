...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        llvmWindowMenuItem.setEnabled(false);
        llvmWindowMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                llvmWindowMenuItemActionPerformed(evt);
            }
        });
        triangleMenu.add(llvmWindowMenuItem);
    ...
    javax.swing.JMenuItem llvmWindowMenuItem;
