...
entry:
  ...
  %temp3 = mul i32 %temp2, 2
  %temp4 = sub i32 %temp3, 3
  store i32 %temp4, i32* %z
  %temp5 = load i32, i32* %z
  call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.int, i32 0, i32 0), i32 %temp5)
  ret i32 0
}
